          ...
          <div className={`${container} relative`}>
            <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/courses" className="inline-flex items-center gap-2.5 rounded-full bg-gold px-7 py-3.5 text-sm font-black text-navy shadow-xl transition-all hover:scale-105 hover:bg-gold-light">
