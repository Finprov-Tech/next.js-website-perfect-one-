        ...
        <div className={container}>
          ...
          <Reveal>
            <div className="mt-12 rounded-3xl bg-gradient-to-r from-cta via-teal to-cta p-8 text-center text-white shadow-xl shadow-cta/20 sm:p-12">
              ...
              <Link href="/contact" className="btn-gloss mt-7 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3.5 font-bold text-navy">Talk to Finprov <ArrowUpRight className="h-4 w-4" /></Link>
            </div>
          </Reveal>
        </div>
      </section>
